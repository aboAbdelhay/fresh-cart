...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-[#f8f9fa] fixed w-full z-20 top-0 start-0 border-b border-gray-200">
            ...
            {localStorage.getItem("userToken") ? (
              <>
                ...
                <div className="relative">
                  ...
                  {isMenuOpenImg && (
                    <div
                      className="z-50 absolute right-0 mt-2 w-72 bg-white divide-y divide-gray-100 rounded-lg shadow"
                      id="user-dropdown"
                    >
