        ...
        <div className="mx-auto md:w-1/2 py-12 px-6 shadow-css  rounded-lg mt-4">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className="tr3 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center"
              >
                Send code
              </button>
            </div>
